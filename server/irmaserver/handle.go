...
func (session *session) handleGetClientRequest(min, max *irma.ProtocolVersion, clientAuth irma.ClientAuthorization, vc string) (
...
// Why global constant if reintroduced everywhere? TODO: find place to put global constants for entirity of irmago
const (
